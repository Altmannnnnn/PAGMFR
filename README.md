...
Data Preparation
1. MVTec AD Dataset
Visit MVTec AD official website
Download and extract the dataset

2. Texture Dataset (required for texture categories)
You can use DTD dataset or custom texture images
...
# Perform validation
i_auroc, p_auroc, pro = validate_pagmfr(model, test_loader)print(f"Test Results - I-AUROC: {i_auroc:.4f}, P-AUROC: {p_auroc:.4f}, PRO: {pro:.4f}")
...
# Modify anomaly map fusion strategydef forward(self, features, rec_features, img, rec_img):
